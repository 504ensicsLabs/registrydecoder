...
class generate_forms:
    ...
    def search_plugin_export_form(self, ref_obj, fileid, tab_name, label_text, results=None, is_diff=0):
        ...
        #ref_obj is the type of the tab called in
        for report in ref_obj.gui.RD.ref_rm.reports:
        ...
        # a reference to the tab that generated me
        new_tab.analysis_tab = ref_obj
    ...
    def export_all_form(self, ref_obj, tab_name):
        ...
        for report in ref_obj.RD.ref_rm.reports:
